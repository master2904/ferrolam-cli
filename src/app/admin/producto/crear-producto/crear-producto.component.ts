...
export class CrearProductoComponent implements OnInit {
  numero:any=/[0-9]+/;
  sigla:any=/[Ll][A-Za-z 0-9-]{5,30}/;
  letras:any=/[A-Za-z ]{6,30}/;
  file:File=null;
  nombre=null;
  createFormGroup(){
    return new FormGroup({
      ...
      maquinas: new FormControl('',[Validators.required,Validators.min(10),Validators.max(60)]),
      columnas: new FormControl('',[Validators.required,Validators.min(3),Validators.max(10)]),
